...
# Install package if needed (keep this if your markdown depends on it)
R CMD INSTALL --preclean .

# Render the R Markdown file
Rscript -e "rmarkdown::render('~/Dispatching/report/multihome/report_search_parameter_for_positive_costs.Rmd', output_file='output.html')" > log_rmarkdown_render 2>&1
