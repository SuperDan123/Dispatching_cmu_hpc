...
dir.create(
  "output/multihome/counterfactual/minimum_wage",
  recursive = TRUE,
  showWarnings = FALSE
)
...
saveRDS(
  counterfactual_tj,
  file = paste0(
    "output/multihome/counterfactual/minimum_wage/counterfactual_minimum_wage_t",
    sprintf("%04d", t),
    "_j",
    sprintf("%04d", j),
    ".rds"
...
cat("Saved results for market", t, ", zone", j, "to output/multihome/counterfactual/minimum_wage/\n")
