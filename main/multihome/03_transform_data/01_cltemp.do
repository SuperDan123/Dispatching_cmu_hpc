...
use $datapath\data_establishments.dta;
...
*qui regress margin hh_p rstaff rtraining rlength2d_7d-rlengthmisc tempdaily tempperm tempfixed register client i.year;
*drop if e(sample)~=1;
*count;

save $datapath\tempagency, replace;
log close;
exit;
